...
>
> [Sentinel 官方文档仓库](https://github.com/sentinel-group/sentinel-website)
>
> [Spring Cloud Alibaba Sentinel Overview](https://sca.aliyun.com/en/docs/2023/user-guide/sentinel/overview/)
>
> [Spring Cloud Alibaba Sentinel Advanced Guide](https://sca.aliyun.com/en/docs/2022/user-guide/sentinel/advanced-guide/)
>
> [CtSph.java](https://github.com/alibaba/Sentinel/blob/master/sentinel-core/src/main/java/com/alibaba/csp/sentinel/CtSph.java)
>
> [DefaultSlotChainBuilder.java](https://github.com/alibaba/Sentinel/blob/master/sentinel-core/src/main/java/com/alibaba/csp/sentinel/slots/DefaultSlotChainBuilder.java)
>
> [FlowSlot.java](https://github.com/alibaba/Sentinel/blob/master/sentinel-core/src/main/java/com/alibaba/csp/sentinel/slots/block/flow/FlowSlot.java)
>
> [DegradeSlot.java](https://github.com/alibaba/Sentinel/blob/master/sentinel-core/src/main/java/com/alibaba/csp/sentinel/slots/block/degrade/DegradeSlot.java)
>
> [SentinelResourceAspect.java](https://github.com/alibaba/Sentinel/blob/master/sentinel-extension/sentinel-annotation-aspectj/src/main/java/com/alibaba/csp/sentinel/annotation/aspectj/SentinelResourceAspect.java)
