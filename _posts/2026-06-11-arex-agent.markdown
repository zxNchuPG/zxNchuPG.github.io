...
![AREX Replay 录制用例列表](/asserts/images/2026-06-11-arex-agent/replay-app-list.png)
...
![AREX 录制回放流程](/asserts/images/2026-06-11-arex-agent/record-replay-process.png)
...
![AREX Agent 启动流程](/asserts/images/2026-06-11-arex-agent/agent-startup-process.png)
...
![ClassLoader 隔离模型](/asserts/images/2026-06-11-arex-agent/classloader-isolation.png)
...
![字节码增强示例](/asserts/images/2026-06-11-arex-agent/bytecode-enhancement.png)
...
![开始回放操作](/asserts/images/2026-06-11-arex-agent/start-replay.png)
...
![回放差异场景分析](/asserts/images/2026-06-11-arex-agent/diff-scenes.png)
