...
![img.png](/asserts/images/2020-08-04-JAVA虚拟机-Ⅱ/标记清除算法.png)
...
![img.png](/asserts/images/2020-08-04-JAVA虚拟机-Ⅱ/复制算法.png)
...
![img.png](/asserts/images/2020-08-04-JAVA虚拟机-Ⅱ/标记压缩算法.png)
...
![img.png](/asserts/images/2020-08-04-JAVA虚拟机-Ⅱ/串行收集器.png)
...
![img.png](/asserts/images/2020-08-04-JAVA虚拟机-Ⅱ/并行收集器.png)
...
![img.png](/asserts/images/2020-08-04-JAVA虚拟机-Ⅱ/8之前的内存分配.png)

而在 G1 回收器中，其将一大块的内存分为许多细小的区块，从而不要求内存是连续的

![img.png](/asserts/images/2020-08-04-JAVA虚拟机-Ⅱ/8之后的内存分配.png)
...
![img.png](/asserts/images/2020-08-04-JAVA虚拟机-Ⅱ/ConcurrentMarking.png)

4. Remark, 再标记，会有短暂停顿(STW)。再标记阶段是用来收集 并发标记阶段 产生新的垃圾(并发阶段和应用程序一同运行)；G1中采用了比CMS更快的初始快照算法:snapshot-at-the-beginning (SATB)

5. Copy/Clean up，多线程清除失活对象，会有STW。G1将回收区域的存活对象拷贝到新区域，清除Remember Sets，并发清空回收区域并把它返回到空闲区域链表中

![img.png](/asserts/images/2020-08-04-JAVA虚拟机-Ⅱ/CopyClean.png)

6. 复制/清除过程后。回收区域的活性对象已经被集中回收到深蓝色和深绿色区域

![img.png](/asserts/images/2020-08-04-JAVA虚拟机-Ⅱ/AfterCopyClean.png)
